...
import com.point.pointaicodemother.constant.AppConstant;
import com.point.pointaicodemother.core.AiCodeGeneratorFacade;
...
import com.point.pointaicodemother.model.enums.ChatHistoryMessageTypeEnum;
...
import com.point.pointaicodemother.service.ChatHistoryService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public boolean removeById(Serializable id) {
        ...
        // 先删除关联的对话历史,即使对话历史删除失败,也不阻止应用删除。只记录错误日志，确保业务的稳定性
        try {
